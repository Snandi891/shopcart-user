...
const Phonedata = () => {
  ...
  useEffect(() => {
    if (!id) {
      ...
      axios
        .get(`https://project-x-five-smoky.vercel.app/api/phone?id=${id}`)
        .then((response) => {
    ...
    <ScrollView>
      <View>
        ...
        >
          ...
          <Text style={{ paddingTop: 7, fontSize: 16 }}>
            Rom : {" " + product?.rom}
          </Text>
          <Text style={{ paddingTop: 7, fontSize: 16 }}>
          ...
          <Text style={{ paddingTop: 7, fontSize: 16 }}>
            Front Camera : {" " + product?.front}
          </Text>
          <Text style={{ paddingTop: 7, fontSize: 16 }}>
            Back Camera : {" " + product?.back}
          </Text>
...
const UserModel = (props) => {
  ...
  const sizes = ["8GB - 128Gb", "4GB - 64Gb", "3GB - 32Gb"];
        ...
        >
          ...
          >
            ...
            <View style={{ gap: 10, paddingTop: 10 }}>
              ...
              <Text style={{ fontSize: 18 }}>Select Stoage:</Text>
              ...
              <Text numberOfLines={1} style={{ fontSize: 15, maxWidth: 200 }}>
                Processor : {props.selectedUser.processor}
              </Text>
              ...
              size : {props.selectedUser.gender}
            </Text> */}
            </View>
          </View>
          <View
