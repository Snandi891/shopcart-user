...
const slider = () => {
  ...
  useEffect(() => {
    if (!id) {
      ...
      axios
        .get(`https://project-x-five-smoky.vercel.app/api/banner?id=${id}`)
        .then((response) => {
      ...
      <View>
        ...
        >
          ...
          >
            ...
            >
              <View className="  items-start " style={styles.containers}>
                <Animated.View
                  entering={SlideInDown.delay(5000).duration(3600)}
            ...
            >
              <View className="   items-start " style={styles.containers}>
                <Animated.View
                  entering={SlideInDown.delay(7000).duration(3600)}
                  className="rounded-2xl "
                  style={{
                    backgroundColor: "rgba(255,255,255,0.7)",
                    padding: moderateScale(3),
            ...
            >
              <View className="   items-start " style={styles.containers}>
                <Animated.View
                  entering={SlideInDown.delay(8000).duration(3600)}
                  className="rounded-2xl "
                  style={{
                    backgroundColor: "rgba(255,255,255,0.7)",
                    padding: moderateScale(3),
            ...
            >
              <View className="  items-start " style={styles.containers}>
                <Animated.View
                  entering={SlideInLeft.delay(9000).duration(3600)}
                  className="rounded-2xl "
                  style={{
                    backgroundColor: "rgba(255,255,255,0.7)",
                    padding: moderateScale(3),
